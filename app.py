    ...
    def regression():
        ...
        with st.form('Regression'):
            ...
            with col1:
                ...
                quantity_log = st.text_input(label='Quantity Tons (Min: 0.00001 & Max: 1000000000)', value="10")
            ...
            with col3:
                ...
                customer = st.text_input(label='Customer ID (Min: 12458000 & Max: 2147484000)', value="123")
    ...
    def classification():
        ...
        with st.form('Classification'):
            ...
            with col3:
                ...
                selling_price_log = st.text_input(label='Selling Price (Min: 0.1 & Max: 100001000)', value="100")
